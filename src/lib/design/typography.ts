export type TypographyPresetName = 'small' | 'medium' | 'large';
...
export const typographyPresets: Record<TypographyPresetName, TypographyPreset> = {
...
export function scale(preset: TypographyPreset, steps = 0): number {
